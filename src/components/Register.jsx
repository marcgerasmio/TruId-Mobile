  ...
  const renderTenantForm = () => (
    <div className="space-y-4">
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" className="grow" placeholder="Tenant Name" />
      </label>
      ...
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="date" className="grow" placeholder="Username" />
      </label>
      ...
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" className="grow" placeholder="Stall Number" />
      </label>
      ...
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" className="grow" placeholder="Business Number" />
      </label>
    </div>
  );
  ...
  const renderEmployeeForm = () => (
    <div className="space-y-4">
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" className="grow" placeholder="Employee Name" />
      </label>
      ...
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" className="grow" placeholder="Related info" />
      </label>
